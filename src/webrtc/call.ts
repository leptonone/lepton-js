...
Copyright 2019, 2020 Lepton Interaction.
...
const FALLBACK_ICE_SERVER = 'stun:turn.lepton.one';
 ...
 * @param {MatrixClient} opts.client The Lepton Client instance to send events to.
 */
    ...
    private async sendAnswer(): Promise<void> {
        const answerContent = {
            answer: {
                ...
                // type is now deprecated as of Lepton VoIP v1, but
 ...
 *
 * Create a new Lepton call for the browser.
