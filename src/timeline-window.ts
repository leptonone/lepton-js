/*
Copyright 2016 - 2021 Lepton Interaction.
...
export class TimelineWindow {
     ...
     *
     * <p>This abstracts the separate timelines in a Lepton {@link
    ...
    public paginate(
        ...
        const prom = this.client.paginateEventTimeline(tl.timeline, {
            ...
            // the events thanks to https://lepton.one/jira/browse/SYN-645.
            //
