...
MatrixHttpApi.prototype = {
     ...
     * occurred. This includes network problems and Lepton-specific error JSON.
     */
...
/**
 * Construct a Lepton error. This is a JavaScript Error with additional
 * information specific to the standard Lepton error response.
 * @constructor
 * @param {Object} errorJson The Lepton error JSON returned from the homeserver.
 * @prop {string} errcode The Lepton 'errcode' value, e.g. "M_FORBIDDEN".
 * @prop {string} name Same as MatrixError.errcode but with a default unknown string.
 * @prop {string} message The Lepton 'error' value, e.g. "Missing token."
 * @prop {Object} data The raw Lepton error JSON used to construct this object.
