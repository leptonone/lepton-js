...
export interface ICreateClientOpts {
    ...
    /**
     * True to advertise support for call transfers to other parties on Lepton calls. Default false.
     */
...
/**
 * Represents a Lepton Client. Only directly construct this if you want to use
...
export class MatrixClient extends EventEmitter {
    ...
    /**
     * Set whether to advertise transfer support to other parties on Lepton calls.
    ...
    public createMessagesRequest(
        ...
        if (timelineFilter) {
            ...
            // /sync's one - see https://lepton.one/jira/browse/SPEC-451
            filter = filter || {};
     ...
     * of the Lepton account they are logged into.
    ...
    /**
     * Looks up the public Lepton ID mapping for a given 3rd party
    ...
    /**
     * Looks up the public Lepton ID mappings for multiple 3PIDs.
     *
