...
export class MatrixEvent extends EventEmitter {
    ...
    /**
     * Construct a Lepton Event object
     * @constructor
     *
     ...
     * from changes to event JSON between Lepton versions.
     *
    ...
    constructor(public event: Partial<IEvent> = {}) {
        ...
        // field that Lepton never otherwise looks at, but it will still take up a lot
     ...
     * @return {string} The user ID, e.g. <code>@alice:lepton.one</code>
     */
     ...
     * @return {string} The room ID, e.g. <code>!cURbafjkfsMDVwdRDQ:lepton.one
     * </code>
     */
