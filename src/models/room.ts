...
export class Room extends EventEmitter {
    ...
    constructor(
        ...
        super();
        // In some cases, we add listeners for every displayed Lepton event, so it's
    ...
    private checkVersionAgainstCapability(versionCap: IRoomVersionsCapability): IRecommendedVersion {
        ...
        // off the version being in the Lepton spec namespace or not (if the version
     ...
     * @param {string} userId the ID of the Lepton user to check permissions for
