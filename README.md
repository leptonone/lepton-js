# Lepton Javascript SDK

This is the [Lepton](https://lepton.one) Client-Server r0 SDK for
...
const client = sdk.createClient("https://lepton.one");
...
This SDK provides a full object model around the Lepton Client-Server API and emits
...
work for unencrypted rooms, but it will not support the E2E parts of the Lepton
specification.
